...
t4 = threading.Thread(target=ws.picture)
...
myLabel = Label(main_window, image=myImg).place(x=310, y=110)
data = Label(main_window, text="DATA OF STATES", font="times 12 bold italic", bg="green", fg="white").place(x=370, y=80)
#            ---------------------------------------------------------------------
#            ------------------------- end buttons ------------------------------
def info():
     h = variable.get()
...
B3 = Button(main_window, text='show stats', font='haventica 11', fg='green',command=info and ws.t).place(x=100, y=350)
#           ---------------------------------------------------------------------
